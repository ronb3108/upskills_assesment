...
def detect_language(text, language_freqs=None, char_freqs=None):
    """
    Detects the language of the given text using character
    and word frequencies.

    Parameters:
    text (str): The input text to detect the language for.
    language_freqs (dict): Dictionary of word frequencies for different
    languages.
    char_freqs (dict): Dictionary of character frequencies for different
    languages.
